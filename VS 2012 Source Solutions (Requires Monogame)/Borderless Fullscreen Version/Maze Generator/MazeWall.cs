...
{
    // The class used to represent a wall between two nodes within a maze.
    class MazeWall
    {
        ...
        // The property used to get the coordinate position of the first node of the two which the MazeWall separates.
        public Vector2 FirstNodeCoordinate
        {
            get { return firstNodeCoordinate; }
        }

        // The property used to get the coordinate position of the second node of the two which the MazeWall separates.
        ...
        public void Draw(Color color, Maze maze, SpriteBatch spriteBatch, Texture2D texture)
        {
            ...
            if (orientation == MazeOrientation.Horizontal)
            {
                ...
                spriteBatch.Draw(texture, new Rectangle(wallHorizontalDrawPosition, wallVerticalDrawPosition, (int)maze.WallDrawThickness, (int)(maze.CoordinateSize + maze.WallDrawThickness)),
                    color);
            }
            ...
            else if (orientation == MazeOrientation.Vertical)
            {
                ...
                spriteBatch.Draw(texture, new Rectangle(wallHorizontalDrawPosition, wallVerticalDrawPosition, (int)(maze.CoordinateSize + maze.WallDrawThickness), (int)maze.WallDrawThickness),
                    color);
            }
        }
        ...
        // The coordinate position within the maze of the first node of the two which are separated by the MazeWall.
        private Vector2 firstNodeCoordinate;
        // The coordinate position within the maze of the second node of the two which are separated by the MazeWall.
